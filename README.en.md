...
| **[danielblnc / DLSS-NR-on-AMD](https://github.com/danielblnc/DLSS-NR-on-AMD)** | Core AMD Neural Rendering runtime (0.3.0 / 0.3.1 / 0.4.0) | Calls standard runtime without core modifications; adds D3D12 state protection for the mapped 0.3.1/0.4.0 1-pixel draw wait |
