...
| **[danielblnc / DLSS-NR-on-AMD](https://github.com/danielblnc/DLSS-NR-on-AMD)** | Core AMD Neural Rendering runtime (0.3.0 / 0.3.1 / 0.4.0 / 0.4.1) | Calls standard runtime without core modifications; adds D3D12 state protection for the mapped 0.3.1/0.4.x 1-pixel draw wait |
...
- **`danielblnc` Specific**:
  ...
  - **0.4.x only**: `Style` (Default / Natural / Cinematic), `Tone curve` (Reinhard / ACES), `Black lift` (0–0.25), `Exposure` (game-provided / auto), and `Tone intensity` (0–2).
